(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://kevinslin.github.io/dendron-1/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://kevinslin.github.io/dendron-1/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://kevinslin.github.io/dendron-1/assets/css/just-the-docs-' + theme + ".css"
      );
    };
